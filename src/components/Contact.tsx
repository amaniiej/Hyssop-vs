...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative py-16 px-6 bg-[#0b1f1a] overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-150 h-100 bg-emerald-500/10 blur-[120px] rounded-full pointer-events-none" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        <div className="text-center mb-10">
          <h3 className="text-3xl md:text-4xl font-serif text-white mb-2">
            The <span className="text-transparent bg-clip-text bg-linear-to-r from-green-400 to-emerald-200">Sanctuary</span> Connection
          </h3>
        ...
        <div className="grid lg:grid-cols-5 gap-8 items-start">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="p-4 rounded-2xl bg-white/3 border border-white/10 backdrop-blur-md flex items-center gap-4 hover:border-green-500/30 transition-all group">
            ...
            <a href={`https://wa.me/${whatsappNumber.replace(/[^0-9]/g, "")}`} target="_blank" rel="noopener noreferrer" className="p-4 rounded-2xl bg-white/3 border border-white/10 backdrop-blur-md flex items-center gap-4 hover:border-green-500/30 transition-all group">
              <div className="w-10 h-10 rounded-full bg-green-500/10 flex items-center justify-center text-green-400 group-hover:bg-green-500 group-hover:text-white transition-all">
                <FaWhatsapp />
              </div>
              <div>
          ...
          <div className="lg:col-span-3 relative group">
            ...
            <div className="absolute -inset-1 bg-linear-to-br from-green-500/20 to-emerald-900/20 rounded-4xl blur opacity-25 group-hover:opacity-50 transition duration-1000"></div>
            
            <form onSubmit={handleSubmit} className="relative bg-linear-to-br from-[#0f3d2e] to-[#0b1f1a] p-8 rounded-4xl border border-white/10 shadow-2xl space-y-4">
              ...
              <button type="submit" className="w-full py-4 bg-linear-to-r from-green-500 to-emerald-600 text-white font-bold rounded-xl text-xs uppercase tracking-[0.2em] flex items-center justify-center gap-3 hover:shadow-[0_0_20px_rgba(34,197,94,0.3)] transition-all cursor-pointer">
